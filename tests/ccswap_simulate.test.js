...
test('simple test with a ccswap gate above: white/black in, black/white out', () => {
    ...
    let swap_gate = new ccswap.CCSwap(120, 60, 120, 60);
...
test('mediocre test with two not gates and a ccswap gate below: white/black in, white/black out', () => {

    let white_ball_in = new ball.Ball(0, '+', 150, 30, 30);
    let black_ball_in = new ball.Ball(1, '+', 210, 30, 30);
    let white_ball_out = new ball.Ball(0, '+', 150, 210, 30);
    let black_ball_out = new ball.Ball(1, '+', 210, 210, 30);
    let swap_gate = new ccswap.CCSwap(120, 120, 120, 60);
...
test('mediocre test with two not gates and a ccswap gate above: white/black in, white/black out', () => {
...
test('mediocre test with two not gates and a ccswap gate above and below: white/black in, black/white out', () => {

    let white_ball_in = new ball.Ball(0, '+', 150, 30, 30);
    let black_ball_in = new ball.Ball(1, '+', 210, 30, 30);
    let white_ball_out = new ball.Ball(0, '+', 210, 270, 30);
    let black_ball_out = new ball.Ball(1, '+', 150, 270, 30);
    let swap_gate_1 = new ccswap.CCSwap(120, 60, 120, 60);
    let not_gate_1 = new not.Not(120, 120, 60, 60);
    let not_gate_2 = new not.Not(180, 120, 60, 60);
    let swap_gate_2 = new ccswap.CCSwap(120, 180, 120, 60);
...
test('hard test with two not gates and a ccswap gate above and below: white/black in, black/white out', () => {
    ...
    let swap_gate_1 = new ccswap.CCSwap(120, 60, 120, 60);
    let swap_gate_2 = new ccswap.CCSwap(240, 60, 120, 60);
    let swap_gate_3 = new ccswap.CCSwap(180, 120, 120, 60);
    let swap_gate_4 = new ccswap.CCSwap(120, 180, 120, 60);
    let swap_gate_5 = new ccswap.CCSwap(240, 180, 120, 60);
    let not_gate_1 = new not.Not(120, 120, 60, 60);
